...
CFLAGS_PYEMBED = ['-fno-common', '-dynamic', '-g', '-fwrapv', '-O3', '-Os', '-isysroot/Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk', '-lpython3.8']
CFLAGS_PYEXT = ['-fno-common', '-dynamic', '-g', '-fwrapv', '-O3', '-Os', '-isysroot/Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk', '-ldl']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'clang'
COMPILER_CXX = 'clang++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-common', '-dynamic', '-g', '-fwrapv', '-O3', '-Os', '-isysroot/Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk', '-lpython3.8']
CXXFLAGS_PYEXT = ['-fno-common', '-dynamic', '-g', '-fwrapv', '-O3', '-Os', '-isysroot/Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk', '-ldl', '-Wno-array-bounds']
...
INCLUDES_PYEMBED = ['/opt/local/Library/Frameworks/Python.framework/Versions/3.8/include/python3.8']
INCLUDES_PYEXT = ['/opt/local/Library/Frameworks/Python.framework/Versions/3.8/include/python3.8']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/opt/local/Library/Frameworks/Python.framework/Versions/3.8/lib/python3.8/config-3.8-darwin']
LIBPATH_PYEXT = ['/opt/local/Library/Frameworks/Python.framework/Versions/3.8/lib/python3.8/config-3.8-darwin']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['dl', 'python3.8', 'dl']
LIB_PYEXT = ['dl']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/Users/samirsim/Desktop/Plateforme/LIP-master/static/ns-3.33/build/src/fd-net-device']
...
PYO = 1
PYTAG = 'cpython-38'
PYTHON = ['/Users/samirsim/Desktop/Plateforme/LIP-master/platform-venv/bin/python3']
PYTHONARCHDIR = '/usr/local/lib/python3.8/site-packages'
PYTHONDIR = '/usr/local/lib/python3.8/site-packages'
PYTHON_CONFIG = ['/opt/local/bin/python3.8-config']
PYTHON_VERSION = '3.8'
...
VERSION = '3.33'
cfg_files = ['/Users/samirsim/Desktop/Plateforme/LIP-master/static/ns-3.33/build/ns3/config-store-config.h', '/Users/samirsim/Desktop/Plateforme/LIP-master/static/ns-3.33/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
